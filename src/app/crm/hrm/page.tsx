      ...
      >
        <Card className="border-adsilo-border shadow-sm mt-6">
          <CardHeader>
            ...
            <CardDescription>
              Manage your human resources and employee operations.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex items-center justify-center h-64">
              <div className="text-center">
                <UserPlus className="mx-auto h-12 w-12 text-adsilo-text-muted" />
                <h3 className="mt-4 text-lg font-medium">HR Dashboard</h3>
