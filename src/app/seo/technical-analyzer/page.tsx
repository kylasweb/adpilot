    ...
    <AppLayout>
      ...
      >
        <div className="space-y-6">
          <div>
            <h1 className="text-3xl font-bold">Technical SEO Analyzer</h1>
      ...
      >
        <Card className="border-adsilo-border shadow-sm mt-6">
          <CardHeader>
            ...
            <CardDescription>
              Analyze your website's technical SEO performance.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex items-center justify-center h-64">
              <div className="text-center">
                ...
                <h3 className="mt-4 text-lg font-medium">Technical SEO Analyzer</h3>
