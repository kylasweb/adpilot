    ...
    <AppLayout>
      ...
      >
        <div className="space-y-6">
          <div>
            <h1 className="text-3xl font-bold">Marketplace Checklist</h1>
      ...
      >
        <Card className="border-adsilo-border shadow-sm mt-6">
          <CardHeader>
            ...
            <CardDescription>
              Ensure your marketplace listings are optimized.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex items-center justify-center h-64">
              <div className="text-center">
                <ListChecks className="mx-auto h-12 w-12 text-adsilo-text-muted" />
                <h3 className="mt-4 text-lg font-medium">Marketplace Checklist</h3>
