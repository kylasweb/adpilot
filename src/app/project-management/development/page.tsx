        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-adsilo-text-secondary mt-1">
              Manage your project development lifecycle from conception to completion.
            </p>
          </div>
        </div>
      </motion.div>
      ...
      >
        <Card className="border-adsilo-border shadow-sm mt-6">
          <CardHeader>
            ...
            <CardDescription>
              Track your project development progress and milestones.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex items-center justify-center h-64">
              <div className="text-center">
                ...
                <h3 className="mt-4 text-lg font-medium">Project Development Dashboard</h3>
