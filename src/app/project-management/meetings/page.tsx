        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-adsilo-text-secondary mt-1">
              Schedule and manage project meetings with your team.
            </p>
          </div>
        </div>
      </motion.div>
      ...
      >
        <Card className="border-adsilo-border shadow-sm mt-6">
          <CardHeader>
            ...
            <CardDescription>
              Organize and track all your project meetings.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex items-center justify-center h-64">
              <div className="text-center">
                <Calendar className="mx-auto h-12 w-12 text-adsilo-text-muted" />
                <h3 className="mt-4 text-lg font-medium">Meeting Management</h3>
