    ...
    <AppLayout>
      ...
      >
        <div className="space-y-6">
          <div>
            <h1 className="text-3xl font-bold">Project Collaboration</h1>
            <p className="text-adsilo-text-secondary mt-1">
              Real-time collaboration tools for your projects.
            </p>
          </div>
        </div>
      </motion.div>
          ...
          <CardContent>
            <div className="flex items-center justify-center h-64">
              <div className="text-center">
                ...
                <h3 className="mt-4 text-lg font-medium">Collaboration Dashboard</h3>
