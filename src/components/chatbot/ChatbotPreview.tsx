  ...
  return (
    <div className="w-[350px] max-w-full shadow-lg rounded-lg overflow-hidden flex flex-col border" style={{
      ...
      <div 
        ...
        style={{ backgroundColor: chatbot.theme.primaryColor, color: '#fff' }}
      >
        <div>
        ...
        <button
          className="w-6 h-6 rounded-full flex items-center justify-center bg-white bg-opacity-20 text-white"
                ...
                >
                  <div 
                    ...
                    style={{
                      ...
                      color: message.sender === 'bot' ? '#fff' : '#1f2937'
                    }}
                  >
                    {message.content}
                  </div>
